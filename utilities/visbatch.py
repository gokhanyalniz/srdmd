...
# p5k, nearly-periodic: -0.4386793734790023 0.21134512530014748
    ...
    def render_state_i(i):
        ...
        if domain is not None:
            if domain == "hkw":
                ...
                cpos = [
                    (-2.096839700062512, 1.235600100573039, 1.1517923765852944),
                    (1.2277325227152704, 0.22948514494630656, 0.338083047836113),
                    (0.26333206340563986, 0.9584996449715254, -0.10924584647476483),
                ]
            elif domain == "w03":
                cpos = [
                    (-5.429401639607837, 3.2081039923483647, 3.824135853697096),
                    (2.357475430904993, -0.3577217467386215, 1.2517289794453108),
                    (0.3727620195457797, 0.9169022252699194, -0.14261411598864254),
                ]
